              ...
              <div class="text-center">
                ...
                <div class="mt-4 flex text-sm leading-6 text-gray-600">
                  <label for="file-upload" class="relative cursor-pointer rounded-md bg-white font-semibold text-indigo-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-indigo-500">
                    ...
                    <input id="file-upload" name="file-upload" type="file" class="sr-only" onchange="displayFileName()">
                  </label>
                  <p class="pl-1" id="drag-drop-text">or drag and drop</p>
                  <div id="cancel-button" class="hidden hover:cursor-pointer" onclick="cancelUpload()">
                ...
                <img id="uploaded-image" class="hidden mt-4 max-h-40" src="" alt="Uploaded Image">
              </div>
            </div>
          </div>
